...
namespace FrontOfficeRH1.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DemandesAttestations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TypeAttestation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Statut = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmployeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DemandesAttestations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DemandesAttestations_Employes_EmployeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DemandesAttestations_EmployeId",
                table: "DemandesAttestations",
                column: "EmployeId");
